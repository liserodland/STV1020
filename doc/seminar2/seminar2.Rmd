...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_soyle1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_soyle2.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_kake.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_soyle3.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_hist1.png")
```
...
ggplot(data = ess_subset, aes(x = news)) +
  geom_histogram(binwidth = 10) +
  ggtitle("Histogram med søylebredde på (binwidth) 10 og frekvens")

ggsave("../../output/sem2_hist2.png")
```

```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_hist2.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_hist3.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_hist4.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../../output/sem2_box.png")
```
